...
if __name__ == '__main__':
    ...
    config_dict['save_replay'] = False
    config_dict['test_nepisode'] = 32
    config_dict['use_tensorboard'] = False
    
    config_dict['checkpoint_path'] = None
    for _i, _v in enumerate(params):
        if _v.split("=")[0] == "--checkpoint_path":
            if "=" in _v:
                config_dict['checkpoint_path'] = _v.split("=")[1]
                del params[_i]
            elif _i + 1 < len(params):
                config_dict['checkpoint_path'] = params[_i + 1]
                del params[_i]
                del params[_i]
            break

    config_dict['use_cuda'] = False
    config_dict['runner'] = 'parallel'
    config_dict['batch_size_run'] = 8
